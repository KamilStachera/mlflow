...
class Resource(ABC):
    ...
    def __init__(self, type: ResourceType, target_uri: str):
        self.type = type
...
class DatabricksResource(Resource, ABC):
    ...
    def __init__(self, target_uri="databricks"):
        super().__init__(type=None, target_uri=target_uri)
...
class DatabricksUCConnection(DatabricksResource):
    ...
    def __init__(self, connection_name: str):
        ...
        self.type = ResourceType.UC_CONNECTION
...
class DatabricksServingEndpoint(DatabricksResource):
    ...
    def __init__(self, endpoint_name: str):
        ...
        self.type = ResourceType.SERVING_ENDPOINT
...
class DatabricksVectorSearchIndex(DatabricksResource):
    ...
    def __init__(self, index_name: str):
        ...
        self.type = ResourceType.VECTOR_SEARCH_INDEX
...
class DatabricksSQLWarehouse(DatabricksResource):
    ...
    def __init__(self, warehouse_id: str):
        ...
        self.type = ResourceType.SQL_WAREHOUSE
...
class DatabricksFunction(DatabricksResource):
    ...
    def __init__(self, function_name: str):
        ...
        self.type = ResourceType.FUNCTION
...
class DatabricksGenieSpace(DatabricksResource):
    ...
    def __init__(self, genie_space_id: str):
        ...
        self.type = ResourceType.GENIE_SPACE
